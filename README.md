# PHP Technical Documentation page
...
You can view a live demo of the project [(https://mohanadaltarah.github.io/build-a-technical-documentation-page/)](#). *(Link the hosted project if it's live)*
